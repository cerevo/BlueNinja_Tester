...
INCLUDE = -IRTE -IRTE/Device/TZ1001MBG -Isrc/toshiba_lib
SOURCES = src/main.c
SOURCES += src/IO.c
SOURCES += src/USB.c src/toshiba_lib/debug.c src/toshiba_lib/gpio_wrapper.c src/toshiba_lib/usbhid.c src/toshiba_lib/usbstack.c src/toshiba_lib/timer.c
SOURCES += src/BLE.c
include *.mk
